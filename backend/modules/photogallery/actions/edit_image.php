 ...
 */
class BackendPhotogalleryEditImage extends BackendBaseActionEdit
{
	...
	private function loadForm()
	{
		...
		$this->meta->setUrlCallback('BackendPhotogalleryModel', 'getURLForImage', array($this->record['image_content_id']));
	}
